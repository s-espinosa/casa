FactoryBot.define do
  factory :volunteer, class: "Volunteer", parent: :user do
    ...
    trait :with_cases_and_contacts do
      after(:create) do |user, _|
        assignment1 = create :case_assignment, casa_case: create(:casa_case, casa_org: user.casa_org, :not_transition_aged, court_date: 1.month.ago), volunteer: user
        create :case_assignment, casa_case: create(:casa_case, casa_org: user.casa_org, :transition_aged, birth_month_year_youth: 10.years.ago, court_date: 1.month.ago), volunteer: user
