...
RSpec.describe "/casa_cases", type: :request do
  ...
  let(:valid_attributes) { {case_number: "1234", :transition_aged, birth_month_year_youth: pre_transition_aged_youth_age, casa_org_id: organization.id, hearing_type_id: hearing_type.id, judge_id: judge.id} }
