  ...
  describe "GET /index" do
    ...
    context "when viewing the page as a volunteer" do
      ...
      context "when viewing the page with exactly one transitioning case" do
        let(:casa_case) { build(:casa_case, casa_org: volunteer.casa_org, :transition_aged) }
      ...
      context "when viewing the page with more than one transitioning cases" do
        let(:casa_case_a) { build(:casa_case, casa_org: volunteer.casa_org, :transition_aged) }
        let(:casa_case_b) { build(:casa_case, casa_org: volunteer.casa_org, :transition_aged) }
